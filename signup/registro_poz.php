...
<div class="container">
<div class="row">
<form class="form-horizontal" action="signup_poz.php" method="POST" autocomplete="off">
...
<div id="resultado" class="col-xs-5"></div>
  ...
  <a href="../menu_nav/crud_pozos/admin_crud_poz.php" class="btn btn-default">Regresar</a>
