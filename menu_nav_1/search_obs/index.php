...
<meta charset="UTF-8">
	...
	<title>Observación de pozos</title>

	<link rel="stylesheet" href="../../bootstrap/css/styles/search_obs.css">
...
<ul class="menu">
<li><a class="IconObs" href="#">Observación</a></li>
<li class="dividir"><a href="../../in_out/logout.php">Cerrar Sesión</a></li>
</ul>

<br><br><br>

<h2>Observación de pozos</h2>
<br>
...
document.getElementById('iframe_con').src = "http\://"+ con_ip + "/ram/index.html";
